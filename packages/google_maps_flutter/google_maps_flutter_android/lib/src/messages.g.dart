...
class MapsApi {
  ...
  Future<List<PlatformCluster>> getClusters(String clusterManagerId) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.google_maps_flutter_android.MapsApi.getClusters$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
abstract class MapsCallbackApi {
  ...
  static void setUp(MapsCallbackApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onClusterManagersUpdated$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
        pigeonVar_channel.setMessageHandler((Object? message) async {
          final List<Object?> args = message! as List<Object?>;
          final String arg_clusterManagerId = args[0]! as String;
          final List<PlatformCluster> arg_clusters = (args[1]! as List<Object?>).cast<PlatformCluster>();
          try {
            api.onClusterManagersUpdated(arg_clusterManagerId, arg_clusters);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
