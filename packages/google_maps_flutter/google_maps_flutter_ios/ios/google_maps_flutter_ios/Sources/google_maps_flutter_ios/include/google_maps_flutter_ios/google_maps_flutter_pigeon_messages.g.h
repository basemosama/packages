...
- (void)didUpdateClusterManagersWithIdentifier:(NSString *)clusterManagerId clusters:(NSArray<FGMPlatformCluster *> *)clusters completion:(void (^)(FlutterError *_Nullable))completion;
