...
class AndroidVideoPlayerApi {
  ...
  Future<TrackSelectionsMessage> trackSelections(int textureId) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.trackSelections$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as TrackSelectionsMessage?)!;
    }
  }

  Future<void> setTrackSelection(TrackSelectionsMessage msg) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.setTrackSelection$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
